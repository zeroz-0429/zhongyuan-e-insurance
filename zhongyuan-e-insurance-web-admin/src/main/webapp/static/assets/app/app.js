var App = function () {
     ...
     * 全选功能
     */
    var handlerInitCheckAll=function () {
     ...
     * @param msg
     */
    var handlerUpdateState = function (url,auid,msg) {
        // 可选参数
        if (!msg) msg = null;
     ...
     * @param id 需要删除数据的 ID
     */
    var handlerDeleteSingle = function (url, auid, msg) {
        // 可选参数
        if (!msg) msg = null;
    ...
    return {
         ...
         * @param url
         */
        // deleteSingle: function(url, auid, msg) {
        //     handlerDeleteSingle(url, auid, msg);
        // },

        updateState: function(url, auid, msg) {
            handlerUpdateState(url, auid, msg);
        },
