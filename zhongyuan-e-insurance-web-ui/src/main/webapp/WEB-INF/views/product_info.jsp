...
<c:forEach items="${singleProduct}" var="singleProduct">
    ...
    <div class="gome_container">
        ...
        <div class="prd_firstscreen_left">
            ...
            <div id="magnifier">
                <div class="big-box">
                    <img src="${singleProduct.pictrue}" alt="${singleProduct.name}" >
                </div>

                <div class="small-box">
                    <img id="pic" src="${singleProduct.pictrue}" alt="${singleProduct.name}">
        ...
        <div class="prd_firstscreen_center">
            ...
            <div class="prd_price_1">
                <div class="unitprice">
                    <p>
                        <label class="prd_price_left">价&nbsp&nbsp格</label>
                        <span class="price"><em>¥</em>${singleProduct.price}</span>
                    </p>
                </div>
            </div>
            <!---->
            <div class="prd_buttons" style="margin-top: 180px">
                <a href="/insurance/up?iid=${singleProduct.iid}" class="btn-product btn-addcart">立即购买</a>

                <form action="/favorite/up" method="post">
                    ...
                    <button type="submit" class="btn-product" style="height: 42px">加入收藏</button>
                </form>
            </div>
            <!---->
        </div>
