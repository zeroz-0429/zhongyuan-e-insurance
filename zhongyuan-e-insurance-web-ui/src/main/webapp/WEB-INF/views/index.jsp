...
<div class="beij_center">
    <div class="dp_sy_biaot">
        <div class="dis_jvz">
            ...
            <div class="biaot_minz">
                <c:forEach items="${list1}" var="product" end="0">
                <h1>${product.insuranceCategory.name}</h1>
                </c:forEach>
                <h3>Boutique zone</h3>
            </div>
            <div class="zuoy_xian"></div>
    ...
    <c:forEach items="${list1}" var="product" end="0">
    <a href="/insurance_list?categoryId=${product.insuranceCategory.icid}" style="font-size: 15px;float: right">MORE+</a>
    </c:forEach>
    <div class="jinp_tuij_lb">
        <ul>
            <c:forEach items="${list1}" var="product" end="5">
            <li>
                <a href="/product/info?iid=${product.iid}" class="jngp_img"><img src="${product.pictrue}"></a>
                <a href="/product/info?iid=${product.iid}" class="jinp_biaot">${product.name}</a>
...
<div class="beij_center">
    <div class="dp_sy_biaot">
        <div class="dis_jvz">
            <div class="zuoy_xian"></div>
            <div class="biaot_minz">
                <c:forEach items="${list2}" var="product" end="0">
                    <h1>${product.insuranceCategory.name}</h1>
                </c:forEach>
                <h3>Boutique zone</h3>
            </div>
    ...
    <div class="jinp_tuij_lb">
        <ul>
            <c:forEach items="${list2}" var="product" end="5">
                <li>
                    <a href="/product/info?iid=${product.iid}" class="jngp_img"><img src="${product.pictrue}"></a>
                    <a href="/product/info?iid=${product.iid}" class="jinp_biaot">${product.name}</a>
                    <span>${product.price}</span>
...
<div class="beij_center">
    <div class="dp_sy_biaot">
        <div class="dis_jvz">
            <div class="zuoy_xian"></div>
            <div class="biaot_minz">
                <c:forEach items="${list3}" var="product" end="0">
                    <h1>${product.insuranceCategory.name}</h1>
                </c:forEach>
                <h3>Boutique zone</h3>
            </div>
    ...
    <div class="jinp_tuij_lb">
        <ul>
            <c:forEach items="${list3}" var="product" end="5">
                <li>
                    <a href="/product/info?iid=${product.iid}" class="jngp_img"><img src="${product.pictrue}"></a>
                    <a href="/product/info?iid=${product.iid}" class="jinp_biaot">${product.name}</a>
                    <span>${product.price}</span>
...
<div class="beij_center">
    <div class="dp_sy_biaot">
        <div class="dis_jvz">
            <div class="zuoy_xian"></div>
            <div class="biaot_minz">
                <c:forEach items="${list4}" var="product" end="0">
                    <h1>${product.insuranceCategory.name}</h1>
                </c:forEach>
                <h3>Boutique zone</h3>
            </div>
    ...
    <div class="jinp_tuij_lb">
        <ul>
            <c:forEach items="${list4}" var="product" end="5">
                <li>
                    <a href="/product/info?iid=${product.iid}" class="jngp_img"><img src="${product.pictrue}"></a>
                    <a href="/product/info?iid=${product.iid}" class="jinp_biaot">${product.name}</a>
                    <span>${product.price}</span>
...
<div class="beij_center">
    <div class="dp_sy_biaot">
        <div class="dis_jvz">
            <div class="zuoy_xian"></div>
            <div class="biaot_minz">
                <c:forEach items="${list5}" var="product" end="0">
                    <h1>${product.insuranceCategory.name}</h1>
                </c:forEach>
                <h3>Boutique zone</h3>
            </div>
    ...
    <div class="jinp_tuij_lb">
        <ul>
            <c:forEach items="${list5}" var="product" end="5">
                <li>
                    <a href="/product/info?iid=${product.iid}" class="jngp_img"><img src="${product.pictrue}"></a>
                    <a href="/product/info?iid=${product.iid}" class="jinp_biaot">${product.name}</a>
                    <span>${product.price}</span>
    ...
    <div class="beij_center">
        <div class="picScroll_left_dianp">
            ...
            <div class="bd jinp_tuij_lb">
                <ul class="picList">
                    <c:forEach items="${isActivity}" var="isActivity">
                        <li>
                            <a href="/product/info?iid=${isActivity.iid}" class="jngp_img"><img src="${isActivity.pictrue}"></a>
                            <a href="/product/info?iid=${isActivity.iid}" class="jinp_biaot">${isActivity.name}</a>
