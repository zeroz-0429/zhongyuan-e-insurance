...
<div id="header">
    <div class="header-box">
        ...
        <h3 class="huany"><a href="/insurance/introduce" style="font-size: 15px;color: #0f0f0f;font-weight: bold">投保介绍</a></h3>
    ...
    <c:forEach items="${singleProduct}" var="singleProduct">
        <div class="beij_center">
            <div class="jiar_gouw_c_beij">
                <div class="msg"><i class="c_i_img"></i>订单支付已成功！</div>
                <div class="shangp_jr">
                    <div class="jr_zuo">
                        <a href="#" class="jr_tu"><img src="${singleProduct.pictrue}"></a>
                        <div class="jr_biaot">
                            <p><a href="#">${singleProduct.name}</a></p>
                            <p class="spandf"><span>${singleProduct.price}</span></p>
                        </div>
                    </div>
                    <div class="jr_you">
                        <a class="jr_fanh" onclick="history.go(-1)">返回</a>
                        <a class="jr_qv_gouw_che" href="/insurance/order?ouid=${ordinaryUsers.ouid}">我的订单<em class="jr_jiant"></em></a>
                    </div>
                </div>
            </div>
        </div>
