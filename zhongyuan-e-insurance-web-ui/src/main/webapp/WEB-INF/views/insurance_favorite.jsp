    ...
    <div class="container">
        <div class="cart-shop-goods dangq_honh">
            <div class="cart-shop-header" >
                <div class="cart-col-5"><span class="gouw_c_dianp" >收藏人姓名：${favoriteList.ordinaryUsers.username} </span></div>
                <div class="cart-col-5"><span class="gouw_c_dianp" >收藏时间：<fmt:formatDate value="${favoriteList.created}" pattern="yyyy-MM-dd HH:mm:ss"/> </span></div>
            </div>
            <div class="beij_center">
                <div class="cart-main-header clearfix">
                    <div class="cart-col-3" style="margin-left: 60px">保险图片</div>
                    ...
                    <div class="cart-col-6">
                        <div class="cart-good-amount">相关操作</div>
                    </div>
                </div>
            </div>
            <div class="cart-shop-good">
                <div class="cart-col-2" style="height: 60px;margin-left: 50px">
                    <a href="" target="_blank" class="g-img"><img src="${favoriteList.insurance.pictrue}" alt=""></a>
                </div>
                <div class="fl houj_c">
                    <div class="cart-col-3" style="margin-left: 120px;margin-top: 20px"><a href="#" target="_blank">${favoriteList.insurance.name}</a></div>
                    <div class="cart-col-4" ><div class="cart-good-real-price "style="margin-left: 100px;margin-top: 20px">¥&nbsp;${favoriteList.insurance.price}</div><div class="red"></div></div>
                    <div class="cart-col-5">
                        <div class="gui-count cart-count" style="margin-left: 160px;margin-top: 20px">
                            <span >一年</span>
                        </div>
                    </div>
                    <div class="cart-col-6 " style="margin-top: 10px">
                        <a href="/favorite/delete?iid=${favoriteList.insurance.iid}&ouid=${favoriteList.ordinaryUsers.ouid}" style="margin-left: 170px;color: red">删除</a>
                        <a href="/insurance/up?iid=${favoriteList.insurance.iid}" style="margin-left: 171px;color: green">购买</a>
                    </div>
                </div>
            </div>
        </div>
...
<c:if test="${ordinaryUsers.ouid == null}" >
    <div class="beij_center">
        <div class="jiar_gouw_c_beij">
            <div class="msg"><i class="c_i_img"></i>您还未登录，请登录收藏该产品！</div>
            <div class="shangp_jr">
                <div class="jr_you">
